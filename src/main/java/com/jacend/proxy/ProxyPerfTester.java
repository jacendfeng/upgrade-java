...
import com.jacend.proxy.speed.CglibProxyTest;
import com.jacend.proxy.speed.DecorateTest;
import com.jacend.proxy.speed.DynamicProxyTest;
...
public class ProxyPerfTester {
    ...
    public static void main(String[] args) {
        ...
        Test decorator = new DecorateTest(nativeTest);
        Test dynamicProxy = (Test) DynamicProxyTest.getProxy(nativeTest);
